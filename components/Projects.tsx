import { projects } from "@/app/contents/projects";
  ...
  return (
    <section className=" mx-auto container max-w-5xl md:px-0 px-4">
      <h1
       ...
       md:mb-4 font-semibold text-center md:text-left"
      >
        Projects
      </h1>
              ...
              <div className="absolute bottom-0.5 left-4 z-10 transition-all duration-300 group-hover:-translate-y-3">
                ...
                <div className="flex gap-2 flex-wrap mt-2">
                  {project.technologies.map((tech) => (
                    <span
                      key={tech}
                      className="bg-white/10 text-white border border-white/20 px-2 py-1 rounded-md text-xs flex items-center gap-1"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className=" md:mt-2 mt-0 py-3 md:py-0  transition-all duration-300 md:opacity-0 md:translate-y-3 md:group-hover:opacity-100 md:group-hover:translate-y-0">
                  <a
                    ...
                    target="_blank"
                    className="px-3 py-1  items-center rounded-lg bg-white text-black text-sm font-medium shadow-md hover:bg-gray-200 transition"
                  >
                    View Project
                  </a>
                </div>
